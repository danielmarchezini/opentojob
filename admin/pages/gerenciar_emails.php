            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo SITE_URL; ?>/?route=testar_email" class="btn btn-info btn-sm mr-2">
...
function salvarEdicao() {
    ...
    $.ajax({
        url: '<?php echo SITE_URL; ?>/admin/api_email_processar.php',
        type: 'POST',
...
function salvarAdicao() {
    ...
    $.ajax({
        ...
        error: function(xhr, status, error) {
            ...
            // Exibir mensagem de erro
            alert('Erro ao adicionar modelo: ' + errorMessage);
        }
    });
}
