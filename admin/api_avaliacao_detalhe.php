<?php
/**
 * API para obter detalhes de uma avaliação (versão admin)
 * 
...
// No contexto admin, vamos permitir acesso direto sem verificar a sessão
// Já que este arquivo está dentro da pasta admin e só é acessível por administradores
// Isso resolve problemas de sessão quando a página é carregada via iframe ou redirecionamento
